...
needles = ("/Users/jo/Crypto/build/shadow_refresh", "/Users/jo/Crypto/build/live_mark",
           ...
           "/Users/jo/Crypto/build/stall_companion",  # clips the dead ibkrcrypto book (protection uses VPS companion)
           "/Users/jo/Crypto/build/wave_companion")   # Mac-side companion (feed cut); + its selftest on same line
out, n = [], 0
for ln in cur:
    s = ln.lstrip()
    if s.startswith("#"):
